...
,(1644,'DAJ_Gestionnaire','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1646,'DAJ_Gestionnaire','WORKFLOW_ACTION_TYPE','*','*')
,(1647,'DAJ_Gestionnaire','SIGNALEMENT_VILLE','*','*')
...
,(1261,'DVD_CODIR','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1262,'DEVE_CODIR','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1263,'DPE_CELLULETECHNIQUE','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1265,'DPE_CODIR','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1267,'DPE_FONCTIONNELLE','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
;
INSERT INTO core_admin_role_resource (rbac_id,role_key,resource_type,resource_id,permission) VALUES 
(1268,'DPE_OBSERVATEUR','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1269,'DPE_STANDARD','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1270,'DVD_CHEFDESECTEUR','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1271,'OBSERVATEUR_MAIRIES','GESTION_SUIVI_DES_MESSAGES_BIENVU','*','*')
,(1275,'Observateur_12eme','SIGNALEMENT_VILLE','12','VIEW_VILLE_SIGNALEMENT')
...
,(1288,'OBSERVATEUR_MAIRIE_1er','SIGNALEMENT_VILLE','1','VIEW_VILLE_SIGNALEMENT')
,(1289,'OBSERVATEUR_MAIRIE_2','SIGNALEMENT_VILLE','2','VIEW_VILLE_SIGNALEMENT')
,(1290,'OBSERVATEUR_MAIRIE_3','SIGNALEMENT_VILLE','3','VIEW_VILLE_SIGNALEMENT')
;
INSERT INTO core_admin_role_resource (rbac_id,role_key,resource_type,resource_id,permission) VALUES 
(1291,'OBSERVATEUR_MAIRIE_4','SIGNALEMENT_VILLE','4','VIEW_VILLE_SIGNALEMENT')
,(1292,'OBSERVATEUR_MAIRIE_5','SIGNALEMENT_VILLE','5','VIEW_VILLE_SIGNALEMENT')
,(1293,'OBSERVATEUR_MAIRIE_6','SIGNALEMENT_VILLE','6','VIEW_VILLE_SIGNALEMENT')
,(1294,'OBSERVATEUR_MAIRIE_7','SIGNALEMENT_VILLE','7','VIEW_VILLE_SIGNALEMENT')
,(1295,'OBSERVATEUR_MAIRIE_8','SIGNALEMENT_VILLE','8','VIEW_VILLE_SIGNALEMENT')
,(1296,'OBSERVATEUR_MAIRIE_8','SIGNALEMENT_VILLE','8','VIEW_VILLE_SIGNALEMENT')
,(1297,'OBSERVATEUR_MAIRIE_9','SIGNALEMENT_VILLE','9','VIEW_VILLE_SIGNALEMENT')
,(1298,'OBSERVATEUR_MAIRIE_10','SIGNALEMENT_VILLE','10','VIEW_VILLE_SIGNALEMENT')
,(1300,'OBSERVATEUR_MAIRIE_12','SIGNALEMENT_VILLE','12','VIEW_VILLE_SIGNALEMENT')
,(1301,'OBSERVATEUR_MAIRIE_13','SIGNALEMENT_VILLE','13','VIEW_VILLE_SIGNALEMENT')
;
INSERT INTO core_admin_role_resource (rbac_id,role_key,resource_type,resource_id,permission) VALUES 
(1302,'OBSERVATEUR_MAIRIE_14','SIGNALEMENT_VILLE','14','VIEW_VILLE_SIGNALEMENT')
,(1303,'OBSERVATEUR_MAIRIE_15','SIGNALEMENT_VILLE','15','VIEW_VILLE_SIGNALEMENT')
,(1304,'OBSERVATEUR_MAIRIE_16','SIGNALEMENT_VILLE','16','VIEW_VILLE_SIGNALEMENT')
,(1305,'OBSERVATEUR_MAIRIE_17','SIGNALEMENT_VILLE','17','VIEW_VILLE_SIGNALEMENT')
,(1306,'OBSERVATEUR_MAIRIE_18','SIGNALEMENT_VILLE','18','VIEW_VILLE_SIGNALEMENT')
,(1307,'OBSERVATEUR_MAIRIE_19','SIGNALEMENT_VILLE','19','VIEW_VILLE_SIGNALEMENT')
,(1308,'OBSERVATEUR_MAIRIE_20','SIGNALEMENT_VILLE','20','VIEW_VILLE_SIGNALEMENT')
,(1309,'OBSERVATEUR_MAIRIE_11','SIGNALEMENT_VILLE','11','VIEW_VILLE_SIGNALEMENT')
...
,(1395,'DEVE_VEGETALISATION1','SIGNALEMENT_VILLE','*','*')
...
,(1503,'DVD_PRESTA','SIGNALEMENT_VILLE','*','*')
...
;
INSERT INTO core_admin_role_resource (rbac_id,role_key,resource_type,resource_id,permission) VALUES 
(1599,'DEVE_Admin_User','SIGNALEMENT_VILLE','*','*')
