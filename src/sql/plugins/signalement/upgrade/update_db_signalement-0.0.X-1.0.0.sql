ALTER TABLE public.signalement_export ADD date_requalification varchar(10) DEFAULT '' NULL;
ALTER TABLE public.signalement_export ADD heure_requalification varchar(5) DEFAULT '' NULL;
ALTER TABLE public.signalement_export ADD date_programme varchar(10) DEFAULT '' NULL;
ALTER TABLE public.signalement_export ADD heure_programme varchar(5) DEFAULT '' NULL;

CREATE OR REPLACE FUNCTION public.test_exp_ins_wkf()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare
